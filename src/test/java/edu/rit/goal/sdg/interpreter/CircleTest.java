...
// Utils.exportAsDot(sdg, "/Users/goal/Desktop", "circle");
// }
//
// @AfterClass
...
// final List<Vertex> enterVtcs = vertices.stream()
// .filter(v -> v.getType().equals(VertexType.ENTRY)).collect(Collectors.toList());
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex enterVtx =
// vertices.stream().filter(v -> v.getLabel().equals("main")).findFirst().get();
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex mult3Vtx =
// vertices.stream().filter(v -> v.getLabel().equals("mult3")).findFirst().get();
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex mult3Vtx = vertices.stream()
// .filter(v -> v.getLabel().equals("area=mult3(P, rad, rad)")).findFirst().get();
// final Set<Edge> outgoingEdges = sdg.outgoingEdgesOf(mult3Vtx);
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex mult3Vtx = vertices.stream()
// .filter(v -> v.getLabel().equals("circ=mult3(2, P, rad)")).findFirst().get();
// final Set<Edge> outgoingEdges = sdg.outgoingEdgesOf(mult3Vtx);
...
// .filter(v -> v.getType().equals(VertexType.INITIAL_STATE) && v.getLabel().equals("debug"))
// .findFirst().get();
...
// .filter(v -> v.getType().equals(VertexType.FORMAL_IN) && v.getLabel().equals("op1"))
// .findFirst().get();
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex paramVtx = vertices.stream()
// .filter(v -> v.getType().equals(VertexType.FORMAL_IN) && v.getLabel().equals("op2"))
// .findFirst().get();
// final Set<Edge> incomingEdges = sdg.incomingEdgesOf(paramVtx);
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex paramVtx = vertices.stream()
// .filter(v -> v.getType().equals(VertexType.FORMAL_IN) && v.getLabel().equals("op3"))
// .findFirst().get();
// final Set<Edge> incomingEdges = sdg.incomingEdgesOf(paramVtx);
...
// final Vertex paramVtx = vertices.stream()
// .filter(
// v -> v.getType().equals(VertexType.FORMAL_IN) && v.getLabel().equals("mult3ResultIn"))
// .findFirst().get();
// final Set<Edge> incomingEdges = sdg.incomingEdgesOf(paramVtx);
...
// final Vertex paramVtx = vertices.stream()
// .filter(
// v -> v.getType().equals(VertexType.FORMAL_OUT) && v.getLabel().equals("mult3ResultOut"))
// .findFirst().get();
// final Set<Edge> incomingEdges = sdg.incomingEdgesOf(paramVtx);
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex paramVtx = vertices.stream()
// .filter(v -> v.getType().equals(VertexType.ACTUAL_OUT) && v.getLabel().equals("area"))
// .findFirst().get();
// final Set<Edge> incomingEdges = sdg.incomingEdgesOf(paramVtx);
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex paramVtx = vertices.stream()
// .filter(v -> v.getType().equals(VertexType.ACTUAL_OUT) && v.getLabel().equals("circ"))
// .findFirst().get();
// final Set<Edge> incomingEdges = sdg.incomingEdgesOf(paramVtx);
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex paramVtx = vertices.stream()
// .filter(v -> v.getType().equals(VertexType.CALL) && v.getLabel().equals("output(area)"))
// .findFirst().get();
// final Set<Edge> incomingEdges = sdg.incomingEdgesOf(paramVtx);
...
// final Set<Vertex> vertices = sdg.vertexSet();
// final Vertex paramVtx = vertices.stream()
// .filter(v -> v.getType().equals(VertexType.CALL) && v.getLabel().equals("output(circ)"))
// .findFirst().get();
// final Set<Edge> incomingEdges = sdg.incomingEdgesOf(paramVtx);
