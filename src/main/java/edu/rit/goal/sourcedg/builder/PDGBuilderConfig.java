 ...
 * 
 * The 'normalize' flag will result in the builder breaking down expressions into simpler nodes by
 * introducing fresh variables. This is an experimental feature.
 * 
 * The 'keepLines' flag will result in the builder assigning to every node in the PDG the source
 * code line it originated from.
 * 
 * The 'interproceduralCalls' flag will result in the builder including call edges between
 * procedures.
 * 
 * @author victorjmarin
 *
...
public class PDGBuilderConfig {
  ...
  public String toString() {
    return String.format("[normalize=%s, originalLines=%s, interproceduralCalls=%s]", normalize,
        keepLines, interproceduralCalls);
  }
