package edu.rit.goal.sdg.validation;
...
public class Validate {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    SynchronizedSummaryStatistics globalNodeStats = new SynchronizedSummaryStatistics(), globalEdgeStats = new SynchronizedSummaryStatistics();
        ...
        for (final String p : programPaths) {
          ...
          try (BufferedReader buffer = new BufferedReader(new InputStreamReader(is))) {
            ...
            try {
              ...
              check(programStr, globalNodeStats, globalEdgeStats);
    ...
    System.out.println("Nodes: " + globalNodeStats.getMean() + " +/- " + globalNodeStats.getStandardDeviation() + " (" + globalNodeStats.getMax() + ")");
    System.out.println("Edges: " + globalEdgeStats.getMean() + " +/- " + globalEdgeStats.getStandardDeviation() + " (" + globalEdgeStats.getMax() + ")");
...
//  }
  ...
  private static void check(final String programStr, SynchronizedSummaryStatistics globalNodeStats, SynchronizedSummaryStatistics globalEdgeStats) throws Exception {
	  final Interpreter intrprtr = new Interpreter(programStr);
	  final Program p = intrprtr.interpret();
	  final SysDepGraph sdg = p.getSdg();
	  globalNodeStats.addValue(sdg.vertexSet().size());
	  globalEdgeStats.addValue(sdg.edgeSet().size());
