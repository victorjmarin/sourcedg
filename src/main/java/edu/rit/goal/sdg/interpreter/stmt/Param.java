...
public class Param implements Stmt {
    ...
    public Param(final String x, final VertexType t, final edu.rit.goal.sdg.interpreter.params.Param p) {
	super();
	final boolean suitableVertexType = t.equals(VertexType.FORMAL_IN) || t.equals(VertexType.ACTUAL_IN)
