...
public class Programs {
  ...
  public static Program horwitz() {
    ...
    final IfThenElse l3 =
        new IfThenElse(new Str("DEBUG"), new Assign("rad", new Str("4")), new Skip());
    final edu.rit.goal.sdg.interpreter.params.Param args1 =
        new Params("P", new Params("rad", new Str("rad")));
    final edu.rit.goal.sdg.interpreter.params.Param args2 =
        new Params("2", new Params("P", new Str("rad")));
