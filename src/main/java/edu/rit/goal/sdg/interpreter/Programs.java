...
public class Programs {
	...
	final edu.rit.goal.sdg.interpreter.params.Param args2 = new Params("2",
		new Params("P", new Params("rad", new EmptyParam())));
	final Assign l4 = new Assign("area", new Call("mult3", args1));
	final Assign l5 = new Assign("circ", new Call("mult3", args2));
	final Call l6 = new Call("output", new Params("area", new EmptyParam()));
	final Call l7 = new Call("output", new Params("circ", new EmptyParam()));
