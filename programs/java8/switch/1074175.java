...
public class HibernateEngine {
    ...
    private static Class[] persistedClasses = { CostModel.class, CostDriver.class, CostFunction.class, CostMapping.class, CostType.class, DriverFacet.class, FunctionParameter.class };
